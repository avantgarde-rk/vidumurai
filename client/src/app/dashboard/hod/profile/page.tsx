...
import { User, Mail, Briefcase, ShieldCheck, Award } from 'lucide-react';
...
export default function HodProfile() {
    ...
    if (loading) return <HodDashboardLayout><div className="p-10 text-center">Loading...</div></HodDashboardLayout>;

    return (
        <HodDashboardLayout>
            <div className="relative h-48 rounded-2xl bg-gradient-to-r from-emerald-800 via-teal-800 to-cyan-900 overflow-hidden mb-16 shadow-xl">
            ...
            <div className="max-w-4xl mx-auto px-4 relative -mt-32">
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100 p-8 flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-32 h-32 rounded-full bg-slate-100 border-4 border-white shadow-lg flex items-center justify-center text-4xl font-bold text-teal-800 mb-4">
                            {user.name?.[0]}
                        </div>
                        <span className="bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">HOD</span>
                    </div>
                    ...
                    <div className="flex-1 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <label className="text-xs font-bold text-slate-400 uppercase">Administrative ID</label>
                                <div className="font-semibold text-slate-700 mt-1 flex items-center gap-2">
                        ...
                        <div className="mt-8 pt-8 border-t border-slate-100 text-center text-slate-400 text-sm">
                            <p>To update HOD details, please contact the Principal/Admin Office.</p>
                        </div>
                    </div>
